...
생성한 알람 규칙은 알람 기능을 사용 안 함으로 변경해 일시적으로 끌 수 있습니다.  
알람 규칙은 모든 리전에 동일하게 적용니다. 
...
- 알람 규칙의 **대상 복제 그룹**에 특정 복제 그룹을 지정한 경우, 다른 리전에서는 복제 그룹이 지정되지 않은 상태로 알람 규칙이 동기화되어 해당 리전에서는 모든 복제 그룹에 알람 규칙을 적용하게 됩니다.
